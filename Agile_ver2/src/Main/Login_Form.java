...
public class Login_Form extends javax.swing.JFrame {
    ...
    Login_Service ss = new Login_Service();
    ...
    private void btn_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_LoginActionPerformed
        ...
        boolean flag = false;
        for (Login login : ss.dangNhap(user, pass)) {
            if (login.getUser().equals(user) && login.getPassword().equals(pass)) {
                ...
                if (login.getRole().equalsIgnoreCase("admin")) {
                    ...
                    JOptionPane.showMessageDialog(this, "Tài khoản bạn không có quyền truy cập");
                    return;
                }
    ...
    private void btn_CancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_CancelActionPerformed
        // TODO add your handling code here:
        int result = JOptionPane.showConfirmDialog(this, "Bạn có muốn thoát không?", "Cancel", JOptionPane.YES_OPTION);
