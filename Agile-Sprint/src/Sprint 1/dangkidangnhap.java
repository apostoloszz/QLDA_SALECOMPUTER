...
public class dangkidangnhap extends javax.swing.JFrame {
    ...
    public boolean check(){
        String regexPatter="^(?=.{1,64}@)[A-Za-z0-9_-]+(\\\\.[A-Za-z0-9_-]+)*@[^-][A-Za-z0-9-]+(\\\\.[A-Za-z0-9-]+)*(\\\\.[A-Za-z]{2,})$";
    if(txtEmail.getText().matches(regexPatter)){
           return true;
    }else{
    ...
    private void initComponents() {
        ...
        txtPasswork = new javax.swing.JTextField();
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(txtPasswork, javax.swing.GroupLayout.PREFERRED_SIZE, 292, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private javax.swing.JTextField txtPasswork;
