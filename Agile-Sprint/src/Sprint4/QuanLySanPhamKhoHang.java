 ...
 * @author Admin
 */
public class QuanLySanPhamKhoHang extends javax.swing.JFrame {

    /**
     * Creates new form QuanLySanPhamKhoHang
     */
    public QuanLySanPhamKhoHang() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quản Lý Sản Phẩm và kho hàng");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLySanPhamKhoHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLySanPhamKhoHang().setVisible(true);
            }
        });
    }
